...
## Possible solution for question 2: Make a plot with separte plots for all years for which we have Stroop data
If you don't already have them, you can get the data [here](https://minhaskamal.github.io/DownGit/#/home?url=https://github.com/ethanweed/Stroop/blob/master/Stroop-raw-over-the-years.csv). You will need to unzip the download before you can work with the data.
```{r echo = T, results = 'hide', message=FALSE, warning = F}
rm(list = ls())
library(tidyverse)
library(ggpubr)
...
## Possible solution for question 3: Make a plot that compares native and non-native speakers on the 2019 Stroop data.
...
df$Non.native.speaker. <- as.factor(df$Non.native.speaker.)
df <- gather(df, key = "Condition", value = "Time", -Non.native.speaker.)
